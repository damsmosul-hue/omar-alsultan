...
function calculate() {
  ...
  resultDiv.innerHTML = `
    ...
    ⚠️ <strong>مدة الغرامات بعد خصم 18 شهر</strong>: ${fineDays} يوم<br>
    💰 <strong>المبلغ الابتدائي</strong>: ${baseAmount.toLocaleString()} دينار
  `;
...
function applyStopDays() {
  ...
  finalDiv.innerHTML = `
    ...
    ✅ <strong>المبلغ النهائي المستحق</strong>: ${finalAmount.toLocaleString()} دينار
  `;
}
</script>
